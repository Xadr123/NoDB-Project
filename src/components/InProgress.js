        ...
        return (
            <div style={{ borderWidth: "10px", borderStyle: "ridge", height: "100vh", width: "615px", display: "flex", alignItems: "center", flexDirection: "column", backgroundColor: "rgb(255, 255, 0, .50)"}}>
                ...
                {this.props.inProgress.map(element => {
                    return <div style={{ background: "yellow", height: "40px", width: "500px", display: "flex", justifyContent: "space-evenly", fontWeight: "bolder", fontSize: "20px", alignItems: "center", borderRadius: "40px", borderWidth: "5px", borderStyle: "ridge", borderColor: "#848484", marginTop: "10px" }}>{element.name}
